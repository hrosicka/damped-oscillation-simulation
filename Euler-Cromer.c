...
int main() {
    ...
    while (t <= total_time) {
        ...
        // Aktualizace rychlosti a polohy pomocí Euler-Cromerovy metody
        v += a * dt; // Aktualizace rychlosti
        x += v * dt; // Aktualizace polohy s novou rychlostí
    ...
    printf("Simulace dokončena. Data byla uložena do souboru 'damped_oscillation.txt'.\n");
